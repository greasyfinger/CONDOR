...
class TripletBartDataset(Dataset):
    ...
    def __getitem__(self, idx):
        head, relation, tail, _ = self.triplets[idx]
...
# Initialize wandb
wandb.init(project="comet_bart", entity="shlongthesheep", name="triplet")
...
dataset = TripletBartDataset(
    "path to triples extracted from ConceptNet, from Heal Seed terms",
    tokenizer,
)
...
for epoch in range(num_epochs):
    ...
    if epoch % 10 == 0:
        checkpoint_dir = f"seed_hope/epoch_{epoch}"
